...
<template>
    <div class="mb-10 mt-6">
        ...
        <div class="grid lg:grid-cols-10 md:grid-cols-6 sm:grid-cols-4 gap-2 w-full mx-auto dark:text-black">
            ...
            <SecuritySummaryTile name="Low" :snapshot="props.snapshot" :count="props.summary.low"
                class="col-span-2 bg-sec-low-400 dark:bg-sec-low-500 dark:hover:bg-sec-low-600" />
            <SecuritySummaryTile name="Info" :snapshot="props.snapshot" :count="props.summary.informational"
