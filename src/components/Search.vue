  ...
  <div class="grid grid-cols-12 gap-4 mb-6 mt-4">
    ...
    <div v-if="selectables" class="col-span-12 sm:col-span-2 mt-0.5">
      <select
        id="countries"
        v-model="selected"
        class="bg-gray-50 border border-gray-600 text-gray-900 text-sm rounded-lg focus:ring-accent-500 focus:border-accent-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-accent-500 dark:focus:border-accent-500 text-center"
        @change="select"
      >
