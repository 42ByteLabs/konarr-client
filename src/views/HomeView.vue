  ...
  <main>
    <div class="container mt-4 mb-6 w-full mx-auto px-2">
      ...
      <div v-else>
        ...
        >
          <div
            class="bg-white dark:bg-gray-800 dark:text-white shadow-md rounded-md p-4 text-center pb-6"
          >
            ...
            <div class="grid-cols-3 gap-4 mt-6">
              ...
              <div class="flex items center justify-between mt-4 px-6">
                ...
                >
                <span class="text-lg font-semibold">{{
                  server.projects?.servers || 0
                }}</span>
              </div>
              <div class="flex items center justify-between mt-4 px-6">
                <span class="text-sm text-gray-500 dark:text-gray-200"
                  >Total Containers</span
                >
                <span class="text-lg font-semibold">{{
                  server.projects?.containers || 0
                }}</span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div class="grid-cols-3 gap-4 mt-6">
              ...
              <div class="flex items center justify-between mt-2 px-6">
                <span class="text-sm text-gray-500 dark:text-gray-200"
                  >Total Dependencies</span
                >
                <span class="text-lg font-semibold">{{
                  server.dependencies?.total || 0
                }}</span>
              </div>
              <div class="flex items center justify-between mt-2 px-6">
                <span class="text-sm text-gray-500 dark:text-gray-200"
                ...
                >
                <span class="text-lg font-semibold">{{
                  server.dependencies?.libraries || 0
                }}</span>
              </div>
              <div class="flex items center justify-between mt-2 px-6">
                <span class="text-sm text-gray-500 dark:text-gray-200"
                ...
                >
                <span class="text-lg font-semibold">{{
                  server.dependencies?.applications || 0
                }}</span>
              </div>
              <div class="flex items center justify-between mt-2 px-6">
                <span class="text-sm text-gray-500 dark:text-gray-200"
              ...
              <div class="flex items center justify-between mt-2 px-6">
                ...
                >
                <span class="text-lg font-semibold">{{
                  server.dependencies?.languages || 0
                }}</span>
              </div>
              <div class="flex items center justify-between mt-2 px-6">
                <span class="text-sm text-gray-500 dark:text-gray-200"
                ...
                >
                <span class="text-lg font-semibold">{{
                  server.dependencies?.["package-managers"] || 0
                }}</span>
              </div>
              <div class="flex items center justify-between mt-2 px-6">
                <span class="text-sm text-gray-500 dark:text-gray-200"
              ...
              <div class="flex items center justify-between mt-2 px-6">
                ...
                >
                <span class="text-lg font-semibold">{{
                  server.dependencies?.databases || 0
                }}</span>
              </div>
              <div class="flex items center justify-between mt-2 px-6">
                <span class="text-sm text-gray-500 dark:text-gray-200"
                  >Compression Libraries</span
                >
                <span class="text-lg font-semibold">
